...
import { CartModalProps, ProxyItem } from "@/types/user/socks5-proxy-ips";
                    ...
                    <td className="py-3">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-5 h-5 rounded-full bg-c-red-500/20 hover:bg-c-red-500 text-c-red-400 hover:text-white flex items-center justify-center transition-all shrink-0"
                          title="Remove"
                        >
                          <X size={10} />
                        </button>
                        <button
                          ...
                          className="px-3 py-1 bg-c-emerald-600 hover:bg-c-emerald-500 text-white text-[11px] rounded-md font-semibold transition-colors whitespace-nowrap"
                        >
        ...
        <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-c-slate-800/80">
          ...
          {items.length > 0 && (
            <>
              <button
                onClick={onEmpty}
                className="flex items-center gap-1.5 px-4 py-2 text-[13px] text-c-red-400 bg-c-red-500/10 hover:bg-c-red-500/20 rounded-lg transition-colors"
              >
                <Trash2 size={13} />
                Empty Cart
              </button>
              <button
                onClick={onBuyAll}
                className="px-4 py-2 text-[13px] font-semibold text-white bg-c-emerald-600 hover:bg-c-emerald-500 rounded-lg transition-colors"
              >
