      ...
      <Tabs defaultValue="transactions" className="w-full">
        ...
        <div className="bg-c-bg-700 border border-c-slate-800 rounded-xl p-5 shadow-sm mb-6">
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              <Button className="bg-c-emerald-500 hover:bg-c-emerald-600 text-white px-6 shadow-sm">
        ...
        <div className="bg-c-bg-700 rounded-xl border border-c-slate-800 p-0 overflow-hidden">
          <TabsContent value="all" className="mt-0 outline-none">
            <TransactionsTable searchQuery={searchQuery} showDelete={false} />
          </TabsContent>
          ...
          <TabsContent value="manual-top-up" className="mt-0 outline-none">
            <TransactionsTable searchQuery={searchQuery} showDelete={true} />
          </TabsContent>
        </div>
      </Tabs>
    </div>
