          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 xl:gap-6">
            ...
            <div className="md:col-span-2 space-y-4 xl:space-y-6">
              ...
              <div className="flex justify-end">
                <Button className="bg-c-green-tw-600 hover:bg-c-green-tw-700 text-white px-10 h-11 font-semibold">
                  Update
                </Button>
              </div>
            </div>
              ...
              <Card className="bg-c-zinc-900 border-c-zinc-800 py-3 xl:py-4">
                ...
                <CardContent className="space-y-3 xl:space-y-4 px-3 xl:px-4">
                  ...
                  <div className="space-y-1">
                    ...
                    />
                    <Button className="w-full bg-c-green-tw-600 hover:bg-c-green-tw-700 text-white">
                      Change Password
                    </Button>
                  </div>
